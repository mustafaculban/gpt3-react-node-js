...
//   const [data, setData] = useState(null);
//   const [searchValue, setSearchValue] = useState('');
//   const [completeQueryRunning, isCompleteQueryRunning] = useState(false);
//
//   const apiURL = 'http://localhost:1234/test.php';
//
//   const handleSearchReq = async () => {
//     try {
//       const result = await axios.post('/ai/search', {
...
//
//   const handleCompletionsReq = async () => {
//     isCompleteQueryRunning(true);
//     try {
//       const result = await axios.post(`${apiURL}`, {
//         type: 'completions',
//         engine: 'davinci',
//         searchValue, // 'Where is my',
//         parameters: {
//           max_tokens: 64,
//           temperature: 0.0,
//           top_p: 1,
...
//     const response = await handleCompletionsReq();
//     console.log('response', response.data.data);
//     setData(response.data ? response.data.choices[0].text : response);
//   };
//
//   useEffect(() => {
//     console.log('App rendered');
...
//       <div className="app-header">
//         <img className="logo" src="assets/openai-logo.png" alt="openai-logo" />
//         <h1>OpenAI React App with PHP server</h1>
//       </div>
//       <div className="app-cta">
//         {/* <button */}
//         {/*  type="button" */}
...
//         {/*  Button Updated /}
//         {/* </button> */}
//         <input disabled={completeQueryRunning} placeholder="Enter text" type="text" value={searchValue} id="searchInput" onChange={(e) => (setSearchValue(e.target.value))} />
//         <button
//           type="button"
//           onClick={handleCompletions}
//           disabled={completeQueryRunning}
//         >
//           { !completeQueryRunning ? 'Send Completions Request' : 'Loading...' }
//         </button>
//       </div>
//       {
//         !completeQueryRunning && data && (
//           <div className="app-result">
//             <pre>
//               {data}
//             </pre>
